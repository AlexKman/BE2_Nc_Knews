...
describe('/api', () => {
  ...
  describe('/topics', () => {
    it('GET returns status:200 of an array of all the topics', () => request
      .get('/api/topics')
      .expect(200)
      .then(({ body }) => {
    ...
    it('status :405 handles invalid requests for /api/topics', () => {
      ...
      const invalidRequests = invalidMethods.map(invalidMethod => request[invalidMethod](url).expect(405));
      return Promise.all(invalidRequests);
    });
    it('POST returns status:201 responds with newly added topic', () => request
      .post('/api/topics')
    ...
    it('POST status:400 responds with malformed request body', () => request
      .post('/api/topics')
      .send({ name: 'Alex', description: 'Northcoders' })
      .expect(400));
  });
  describe('/topics/:article_id/articles', () => {
    it('GET returns status:200 of an array of all the articles for a given topic, also tests default limit', () => request
    ...
    it('GET returns status:200 of an array of all the articles for a given topic, tests start query', () => request
    ...
    it('GET returns status:200 of an array of all the articles for a given topic, tests limit query', () => request
      .get('/api/topics/mitch/articles?limit=5')
      .expect(200)
      .then(({ body }) => {
        expect(body.articles.length).to.equal(5);
      }));
    it('GET returns status:404 responds with error 404 not found', () => request
    ...
    it('POST returns status:201 responds with the newly added article', () => {
      const newArticle = {
        title: 'new article',
  ...
  describe('/api/articles', () => {
    it('GET returns status:200 responds with an array of all the articles, also tests default limit query', () => request
      .get('/api/articles')
      .expect(200)
      .then(({ body }) => {
        expect(body.articles.length).to.equal(10);
    ...
    it('GET returns status:200 responds with an array of articles, tests limit query and start query', () => request
    ...
    it('GET returns status:200 responds with an array of articles, tests start query', () => request
  ...
  describe('/api/articles/:article_id', () => {
    it('GET returns status:200 responds with an article with a given article_id', () => request
      .get('/api/articles/4')
      .expect(200)
      .then(({ body }) => {
    ...
    it('GET returns status:404 responds with message:not found', () => request
      .get('/api/articles/250')
      .expect(404)
      .then(({ body }) => {
        expect(body.message).to.equal('Article not found');
      }));
    it('PATCH returns status:204 responds with updated article', () => request
    ...
    it('PATCH returns status:404 responds with message:not found', () => request
      .patch('/api/articles/5000')
      .send({ inc_votes: 50 })
      .expect(404));
    it.only('DELETE returns status:204 responds with no content', () => request
      .delete('/api/articles/1')
      .expect(204)
      .then(() => request.get('/api/articles/1').expect(404)));
    it.only('DELETE returns status:404 when given invalid article_id', () => request.delete('/api/articles/5000').expect(404));
  });
  describe('/api/article/article_id/comments', () => {
    it('GET returns status:200 responds with array of comments with given article_id, tests default limit query', () => request
    ...
    it('GET returns status:200 responds with an array of comments with given article_id, tests limit query and page start query', () => request
  ...
  describe('/api/articles/:article_id/comments/:comment_id', () => {
    it('PATCH returns status:200 responds with updated comment', () => request
    ...
    it('PATCH returns status:404 responds with comment not found', () => request
  ...
  describe('/api/users', () => {
    it('GET returns status:200 of an array of all user objects', () => request
      .get('/api/users')
      .expect(200)
      .then(({ body }) => {
  ...
  describe('/api/users/:username', () => {
    it('GET returns status:200 of user object with given username', () => request
      .get('/api/users/butter_bridge')
      .expect(200)
      .then(({ body }) => {
        expect(body.user.username).to.equal('butter_bridge');
      }));
    it('GET returns status:404 user not found', () => request
      .get('/api/users/alexK')
      .expect(404)
      .then(({ body }) => {
